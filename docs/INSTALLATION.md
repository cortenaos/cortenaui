...
```kotlin
dependencies {
    implementation("io.github.cortenaui:ui-foundation:0.3.1-alpha")
}
```
...
```kotlin
dependencies {
    implementation("io.github.cortenaui:ui-shape:0.3.1-alpha")
}
```
...
```kotlin
dependencies {
    implementation("io.github.cortenaui:ui-motion:0.3.1-alpha")
}
```
